...
Once you've completed this, in your build folder where will be a folder called *"Release-universal"* (or Debug-universal if you used Debug),  in that folder is the *PhotoViewer.fmwk* bundle, just drag that to your app's Xcode Project, and you should be good to go.
